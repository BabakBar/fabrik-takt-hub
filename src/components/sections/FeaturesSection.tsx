            ...
            <div className="text-center">
              <div className="bg-slate-900 text-white p-10 rounded-2xl max-w-4xl mx-auto shadow-2xl">
                ...
                <button 
                  ...
                  className="bg-amber-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-amber-600 transition-colors flex items-center gap-3 mx-auto shadow-lg shadow-amber-500/25"
                >
